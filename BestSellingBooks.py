...
def user_input_features():
    Authors = st.sidebar.selectbox('Author_Name',[ 22,   9,  58,   0,  17,  60,  16,  51, 146,  26, 115,  57, 126,
       ...
       140, 154, 123, 117,   2, 127,  97, 155, 112,  37, 118,  46, 105,
        54])
    Original_language = st.sidebar.selectbox('Original_language', [Chinese, Czech, Dutch, English, French, German, Gujarati, Hindi, Italian, Japanese, Norwegian, Portuguese, Russian, Spanish, Swedish, Yiddish])
